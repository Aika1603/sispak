<div id="page-wrapper">
  ...
  <div class="row">
      <div class="col-lg-12">
        <a href="<?=site_url('admin/kasus_baru')?>" class="btn btn-danger"> Lihat Semua Kasus Baru </a>
        <br/><br/>
                      ...
                      <tbody>
                        ...
                        foreach ($basis_gejala as $row) {
                          ...
                          <tr class="">
                            ...
                            <td>'.$row->bobot.'</td>
                              <td>
                              <a href="'.site_url('admin/kasus_baru/detail_hapus/'.$id.'/'.$row->id).'" title="Hapus"><i class="fa fa-trash"></i> </a>
                            </td>
                          </tr>
                          ';
                          $no++;
